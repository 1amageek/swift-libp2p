/// End-to-end tests for QUIC transport.
///
/// These tests verify actual QUIC connections between client and server,
/// including TLS handshake, PeerID verification, and stream multiplexing.
...
struct QUICE2ETests {
    ...
    func clientServerHandshake() async throws {
        ...
        // Accept connection in background using connections stream
