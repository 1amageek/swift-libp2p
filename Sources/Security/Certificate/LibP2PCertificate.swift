...
///
/// The generated certificate contains a critical X.509 extension with OID
/// `1.3.6.1.4.1.53594.1.1`. The extension value is a DER-encoded ASN.1 structure:
///
/// ```
/// SignedKey ::= SEQUENCE {
...
public enum LibP2PCertificate {
    ...
    public struct GeneratedCertificate: Sendable {
        /// DER-encoded X.509 certificate containing the libp2p extension.
    ...
    /// - Throws: `LibP2PCertificateError` if the certificate is invalid or verification fails
